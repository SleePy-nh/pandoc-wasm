...
-- GHC 9.4+ provides Int64#/Word64# primitives directly in GHC.Prim
-- for all platforms, so we don't need GHC.IntWord64 anymore
...
#endif
#else
-- For 32-bit with GHC 9.4+, word64ToWord# is available in GHC.Prim
word64ToWord (W64# i) = W# (GHC.Prim.word64ToWord# i)
#endif
...
{-# INLINE word64ToWord# #-}
#else
-- For 32-bit platforms, re-export from GHC.Prim
word64ToWord# :: Word64# -> Word#
word64ToWord# = GHC.Prim.word64ToWord#
{-# INLINE word64ToWord# #-}
#endif
...
#else
word64ToWord32s :: Word64 -> Word32x2
-- For 32-bit with GHC 9.4+: word64ToWord# gives Word# which is 32-bit on 32-bit platforms
-- We use wordToWord32# to get a Word32#, and shift for the high word
word64ToWord32s (W64# w64) = Word32x2 (W32# (wordToWord32# (GHC.Prim.word64ToWord# (uncheckedShiftRL64# w64 32#)))) (W32# (wordToWord32# (GHC.Prim.word64ToWord# w64)))
#endif
